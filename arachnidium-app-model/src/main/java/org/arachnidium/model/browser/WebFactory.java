...
public final class WebFactory extends DefaultApplicationFactory {
	 ...
	 */
	public static <T extends BrowserApplication> T getApplication(
			Class<T> appClass) {
	...
	public static <T extends BrowserApplication> T getApplication(
		...
		return load(getApplication(WindowManager.class, appClass, config),
				urlToBeLoaded);
	}
	...
	public static <T extends BrowserApplication> T getApplication(
		...
		return load(
				getApplication(WindowManager.class, appClass, supportedDriver,
						capabilities, remoteAddress), urlToBeLoaded);
	}
	...
	public static <T extends BrowserApplication> T getApplication(
		...
		return load(getApplication(WindowManager.class, appClass),
				urlToBeLoaded);
	}
	...
	private static <T extends BrowserApplication> T load(T instance,
			String urlToBeLoaded) {
