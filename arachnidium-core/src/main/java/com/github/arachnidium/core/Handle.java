...
public abstract class Handle implements IHasHandle, ISwitchesToItself,
    ...
    public SearchContext getSearchContext(){
        ...
        Set<Map.Entry<Class<? extends WebDriver>, Class<? extends WebElement>>> entries = elementTypesMap.entrySet();
        Iterator<Map.Entry<Class<? extends WebDriver>, Class<? extends WebElement>>> iterator = entries.iterator();

        Class<? extends WebElement> target = null;
        while (iterator.hasNext()){
            Map.Entry<Class<? extends WebDriver>, Class<? extends WebElement>> entry = iterator.next();
