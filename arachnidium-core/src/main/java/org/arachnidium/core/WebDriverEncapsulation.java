...
public class WebDriverEncapsulation implements IDestroyable, IConfigurable,
	...
	public WebDriverEncapsulation(Configuration configuration) {
		...
		Capabilities capabilities = this.configuration.getSection(CapabilitySettings.class);
		...
		String remoteAdress = this.configuration.getSection(WebDriverSettings.class)
				.getRemoteAddress();
