Here are parameterized test samples. Parameterization is achieved with default data which is defined in Some parameter sets complement default parameters defined in [settings.json](https://github.com/arachnidium/arachnidium-java/blob/master/arachnidium-tutorial/src/main/java/com/github/arachnidium/tutorial/confuguration/settings.json)
